...
<h3 align="center">HomePie</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/arsonite/homepie"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://homepie.net">Visit Webpage</a>
    ·
...
2. Clone the repo
    ...
    ```sh
    git clone https://github.com/arsonite/homepie.git
    ```
...
See the [open issues](https://github.com/arsonite/homepie/issues) for a full list of proposed features (and known issues).

...
export default defineConfig({
  ...
  server: {
    cors: true,
    host: 'localhost', // Circumvents the insecure-ssl-certificate-warning in browsers
    https: {
      cert: fs.readFileSync('./files/ssl/certificate.crt'),
      key: fs.readFileSync('./files/ssl/private.key'),
    },
    open: true,
    port: 443,
  },
